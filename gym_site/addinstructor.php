...
echo "<h2 style='font-size:200% width:200px'>New Instructor</h2>";
//Form
echo "<form action='insertinstructor.php' method='post'style='width:200px;margin:0 45%;position:relative;left:-55px'>";
//echo "<h2 style='font-size:200% width:200px'>New Instructor</h2>";
