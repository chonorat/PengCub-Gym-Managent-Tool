...
//Form
echo "<h2 style='font-size:200% width:200px'>New Member</h2>";
echo "<form action='insert_member.php' method='post' style='width:200px;margin:0 45%;position:relative;left:-55px'>";
